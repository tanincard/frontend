...
## 🎛️ بخش 2: داشبورد مدیریت (SSG + ISR)

### صفحه محصولات داشبورد - `/dashboard/products`

**نوع Rendering:** SSG (Static Site Generation) + ISR با `revalidate`

**الزامات:**
- Fetch محصولات در زمان Build از Backend
...
│   ├── dashboard/
│   │   └── products/
│   │       └── page.tsx          # داشبورد محصولات (SSG + ISR)
│   ├── layout.tsx
│   └── page.tsx
├── components/
│   ├── ProductCard.tsx
...
- [ ] صفحه `/dashboard/products` با SSG + ISR کار می‌کند
...
✅ **استفاده صحیح از SSR/SSG/ISR** - این خیلی مهم است!  
